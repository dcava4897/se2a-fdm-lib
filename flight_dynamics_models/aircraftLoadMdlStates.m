...
function actuator_states = loadActuatorStates(model_name,aircraft_block_name)
    ...
    actuator_states = ...
        ...
        'dLAD'            , '-',     ''    ,'LAD position'               ,[ model_name, '/', aircraft_block_name, '/commands 2 actuators/Nonlinear Second-Order Actuator LAD/A'];...   
        ...
        'dLAD_dt'         , '-',     ''    ,'LAD position'               ,[ model_name, '/', aircraft_block_name, '/commands 2 actuators/Nonlinear Second-Order Actuator LAD/dot_A'];... 
